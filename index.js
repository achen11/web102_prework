...
const unfundedCount = GAMES_JSON.reduce(
    (accumulator, game) => accumulator + (game.pledged < game.goal),
    0
);

// create a string that explains the number of unfunded games using the ternary operator
const unfundedStatement = unfundedCount === 1 ? `1 game remains unfunded.` : `Currently, ${unfundedCount} games remain unfunded.`;

// create a new DOM element containing the template string and append it to the description container
const displayStr = "Our company loves to fund independent games and hopes to bring more independent games into the world"
